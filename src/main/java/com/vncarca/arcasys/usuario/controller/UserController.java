...
public class UserController {
    ...
    public Page<Usuario> getUsers(@RequestParam(required = true) Integer page,
			@RequestParam(required = true) Integer size,@RequestParam(required = false, defaultValue = "" ,name = "username") String username ){
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        try {
            ...
            response.put("mensaje", "Error al eliminar al usuario en el servidor");
            response.put("error", e.getMostSpecificCause().getMessage());
            return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public Boolean passwordCorrecta(@RequestParam(required = true) Long id,@RequestParam(required = true) String currentPassword) {
        Usuario user = userService.findById(id);
    ...
    public ResponseEntity<?> patchPassword(@PathVariable Long id,@RequestParam(required = true) String passwd) {
         ...
         try {
             ...
             response.put("mensaje", "Error al actualizar la contraseña en EL SERVIDOR");
             response.put("error", e.getMostSpecificCause().getMessage());
             return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
         }
