...
public class TratamientoController {
	...
	@ResponseBody
	@GetMapping("/page")
	public Page<TratamientoDtoExtends> getTratamientos(@RequestParam(required = true) Integer page,
	                                                   @RequestParam(required = true) Integer size) {
		Pageable pageable = PageRequest.of(page, size);
		Page<TratamientoDtoExtends> pageTratamientos = tratamientoService.findAll(pageable);
		return pageTratamientos;
	}
	
	@GetMapping("/")
	public List<TratamientoDtoExtends> getTratamientos() {
	...
	public ResponseEntity<?> create(@Valid @RequestBody TratamientoDto tratamientoDto, BindingResult result, @PathVariable Long idFicha) {
		...
		TratamientoDtoExtends newTratamiento = null;
	 ...
	 public ResponseEntity<?> update(@Valid @RequestBody TratamientoDto tratamientoDto, BindingResult result,
		 ...
		 TratamientoDtoExtends tratamientoUpdate = null;
	 ...
	 public ResponseEntity<?> getById(@PathVariable Long id) {
		 TratamientoDtoExtends tratamiento = null;
		 Map<String, Object> response = new HashMap<>();
	 ...
	 public ResponseEntity<?> findByFichaClinica(@PathVariable Long idFichaClinica) {
		 List<TratamientoDtoExtends> tratamientos = null;
		 Map<String, Object> response = new HashMap<>();
		 try {
